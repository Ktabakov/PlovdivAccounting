...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var translations = {
    en: {
      ...
      'nav.contact':'Contact',
      'nav.cta':'Contact Us',
      'hero.title.line1':'Distinction in',
      'hero.title.line2':'financial management',
      'hero.description':'Professional accounting solutions for Plovdiv businesses. Precision, correctness and clarity at every step.',
      ...
      'footer.about':'About Our Firm',
      'footer.services':'Our Services',
      'footer.news':'Latest News',
      'footer.contact':'Client Area',
      ...
      'contact.address.value':'ul. "Gladston" 123, Center<br>Plovdiv 4000, Bulgaria',
