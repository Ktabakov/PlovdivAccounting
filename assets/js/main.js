...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var translations = {
    en: {
      ...
      'service.accounting.desc':'Full accounting service: journals, balance sheet, financial documents. Benefit: peace of mind and accurate financial reports.',
      'service.payroll.title':'Payroll & HR',
      'service.payroll.desc':'Salary calculation, contributions, regulatory documents. Benefit: correct payment and compliance with labor law.',
      'service.closing.title':'Annual Closing',
      'service.closing.desc':'Preparation and presentation of annual reports and financial analysis. Benefit: confidence with partners and authorities.',
      'service.tax.title':'Tax Returns',
      'service.tax.desc':'Preparation and filing of tax returns for legal and natural persons. Benefit: risk minimization and tax optimization.',
      'service.ongoing.title':'Ongoing Services',
      'service.ongoing.desc':'Daily/monthly accounting maintenance and consultations. Benefit: timely reports and flexible communication.',
